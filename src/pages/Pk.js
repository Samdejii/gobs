  ...
  <div class="container mb-5">
    <div class="row mb-5">
      ...
      <div class="col-md-8 text-center">
        <p class="mb-3">Enhance Payment Experience in Your Store</p>
        <h1><b>Press Kit</b></h1>
        <p>Get information about the entire integration process and make preparations.
          Get information about the entire integration process and make preparations.</p>
      </div>
      <div class="col-md-2"></div>
    </div>
  </div>
...
<div id="container-fluid">
  <div class="container mb-5">
      <p class="text-right mr-5"><b>General Press Kit</b></p>
    ...
    <div class="row">
      <div class="col-md-3">
      <p class="text-left mr-5"><b>Logo Assets & colors</b></p>
        <p class="mt-1 mb-1">All Assets</p>
        <p class="mt-1 mb-1">All Assets</p>
        <p class="mt-1 mb-1">All Assets</p>
        <p class="mt-1 mb-1">All Assets</p>
      </div>
...
<div id="container-fluid">
  <div class="container mb-5">
    <div class="row mb-5 mt-5">
      <div class="col-md-2"></div>
      <div class="col-md-8 text-center">
        <h1><b>Have a Media Enquiry?</b></h1>
        <p>Get information about the entire integration process and make preparations.
          Get information about the entire integration process and make preparations.</p>
          <Link to="/Contact"><button type="submit" class="btn btn-dark mt-5">Contact Us</button></Link>
      </div>
      <div class="col-md-2"></div>
    </div>
  </div>
