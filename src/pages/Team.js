...
<header id="header">
    ...
    <div class="container-fluid">
    <div class="container">
      <div class="row justify-content-center align-self-center mb-5 mt-5">
        ...
        <div class="col-md-5 col-sm-12 intro-img order-md-last order-last clearfix mt-8">
            <img class="d-block" src="assets/img/tennis-1381230_1920.jpg" alt="First slide" style={{height:'45vh',}}/>
        </div>
      </div>
  ...
  <section id="intro" class="clearfix mt-8" style={{background:'white'}}>
    ...
    <p class=" text-center"><b>Meet Our Team</b></p>
    <h2 class=" text-center">Developing a game-changing platform requires expertise from a wide spectrum of fields.</h2>
      <div class="row justify-content-center align-self-center text-center">
        
      <div class="col-md-2 col-sm-6 ml-5 p-3 mt-5">
        <img class="d-block" src="assets/img/Yellow.png" alt="First slide" 
        style={{ background:'black',width:'95%', height:'20vh', borderRadius:'150%'}}/> 
        <br/>
        <p>Dr Sam</p>
        <span>+777 419 911 </span>   
        </div>
      ...
      <div class="row justify-content-center align-self-center text-center mb-5">
      <div class="col-md-2 col-sm-6 ml-5 p-3 mt-5">
        <img class="d-block" src="assets/img/Yellow.png" alt="First slide" 
        style={{ background:'black',width:'95%', height:'20vh', borderRadius:'150%'}}/> 
        <br/>
    ...
    <div class="container">
        <div class="row mt-5">
          <div class="col-md-1"></div>
            <div class="col-md-10 ">
                <h4 class="text-center">Our FAQ's</h4>
        ...
        <div class="row text-center mb-5">
          ...
          <div class="col-md-4">
          <Link to="/Pp" type="button" class="btn btn-outline-dark ml-3 p-2 pl-3 pr-3 mr-3"
           style={{color:'black'}}>Learn more on our support page <img src="assets/img/arrow-circle-right.png"
            alt="" class="img-fluid ml-3"/></Link>
          </div>
          <div class="col-md-4"></div>
