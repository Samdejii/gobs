...
<header id="header">
    ...
    <div class="containe mb-5r">
      <div class="row justify-content-center align-self-center mb-5">
        <div class="col-md-5 col-sm-12 intro-info order-md-first order-first">
            <span>← Updated 14/12/2021</span>

          <h2 class="mb-2">Gobs Terms Of Use</h2>
          ...
          <span>
          LinkedIn<img src="assets/img/arrow-circle-right.png" alt="" class="img-fluid ml-3"/><br/>
          </span>

          <br/><br/><br/>
        </div>
  
        <div class="col-md-6 col-sm-12 intro-img order-md-last order-last clearfix mt-8 p-5">
        </div>
      </div>
...
<div class="container-fuild mb-5">
    <div class="container mb-5">
        ...
        <div class="row mb-5">
            <div class="col-md-10">
            <h5 class="mt-3" style={{color:'green'}}>01</h5>
        <p class="mt-3"><b>Introduction</b></p>
        <p class="mt-3 mb-3">From product to a full ecosystem, we've built an incredible team
           ...
           From product to a full ecosystem, we've built an incredible team
           of experienced people that share our passion for disruptive 
           technology and vision of a new digital payments landscape.</p>
            </div>
        ...
        <div class="row mb-5">
            <div class="col-md-10">
            <h5 class="mt-3" style={{color:'green'}}>02</h5>
        <p class="mt-3"><b>Definations and Interpretations</b></p>
        <p class="mt-3 mb-3">From product to a full ecosystem, we've built an incredible team
           of experienced people that share our passion for disruptive 
           technology and vision of a new digital payments landscape.
           From product to a full ecosystem, we've built an incredible team
        ...
        <div class="row mb-5">
            <div class="col-md-10">
            <h5 class="mt-3" style={{color:'green'}}>03</h5>
        <p class="mt-3"><b>Permitted Use</b></p>
        <p class="mt-3 mb-3">From product to a full ecosystem, we've built an incredible team
           of experienced people that share our passion for disruptive 
           technology and vision of a new digital payments landscape.
           From product to a full ecosystem, we've built an incredible team
        ...
        <div class="row mb-5">
            <div class="col-md-10">
            <h5 class="mt-3" style={{color:'green'}}>04</h5>
        <p class="mt-3"><b>Prohibited Use</b></p>
        <p class="mt-3 mb-3">From product to a full ecosystem, we've built an incredible team
           of experienced people that share our passion for disruptive 
           technology and vision of a new digital payments landscape.
           From product to a full ecosystem, we've built an incredible team
        ...
        <div class="row mb-5">
            <div class="col-md-10">
            <h5 class="mt-3" style={{color:'green'}}>05</h5>
        <p class="mt-3"><b>Content must NOT be relied on</b></p>
        <p class="mt-3 mb-3">From product to a full ecosystem, we've built an incredible team
           of experienced people that share our passion for disruptive 
           technology and vision of a new digital payments landscape.
           From product to a full ecosystem, we've built an incredible team
...
<div class="container-fluid">
    <div class="container">
    <h4 class="mb-5"><b>Continue Reading</b></h4>
    <div class="row mb-5">
        <div class="cards p-1" style={{background:'#007F7F', width:'30%'}}>
