...
<header id="header">
    ...
    <div class="container">
      <div class="row justify-content-center align-self-center mb-5 mt-5">
        ...
        <div class="col-md-5 col-sm-12 intro-img order-md-last order-last clearfix mt-8">
            <img class="d-block" src="assets/img/swimmer-1678307_1920.jpg" alt="First slide" style={{height:'45vh',}}/>
        </div>
      </div>
  ...
  <section id="intro" class="clearfix mt-8" style={{background:'white'}}>
    ...
    <hr/>
    <p class=" text-center">Developing a game-changing platform requires expertise from a wide spectrum of fields.</p>
      <div class="row justify-content-center align-self-center">
        
        <div class="col-md-3 ml-5 p-3 mt-5" style={{ height:'15vh'}}>
            <span>01</span> 
            </div>
        <div class="col-md-7 ml-5 p-3 mt-5" style={{ height:'15vh'}}>
        <span>
          From product to a full ecosystem, we've built an incredible team
           of experienced people that share our passion for disruptive 
           technology and vision of a new digital payments landscape.<br/>
